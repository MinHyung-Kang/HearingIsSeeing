...
opt = {
  ...
  model = "checkpoints/mynet1/iter180_net.t7",   -- which soundnet model to load
  list = "/ihome/cjkymn/cs189/cjkymn/prefixsounds.txt",                             -- text file listing mp3's to process, one per line
